...
public class MessageSentPage implements ActionListener {
    ...
    public MessageSentPage(String currentUsername) {
        ...
        Image image = icon.getImage().getScaledInstance(iconLabel.getWidth(), iconLabel.getHeight(),
                Image.SCALE_SMOOTH);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // After showing to the user that the message is sent successfully, allow the
        // User to return to the Suggestion Box Page
