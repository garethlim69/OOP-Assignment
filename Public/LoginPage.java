...
public class LoginPage implements ActionListener
{
    ...
    */
    ...
    public LoginPage(HashMap<String,String> thisUserInfo)
    {
        ...
        Image image = appIcon.getImage().getScaledInstance(iconLabel.getWidth(),iconLabel.getHeight(), Image.SCALE_SMOOTH);
    ...
    {
        // If the user has no account, they will click the signupButton and go to register page
        ...
        // After login successfully, the user will be directed to their respective home page
