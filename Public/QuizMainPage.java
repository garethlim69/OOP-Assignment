...
public class QuizMainPage implements ActionListener {
    ...
    public QuizMainPage(String currentUser) {
        ...
        Image imageTrophy = trophyIcon.getImage().getScaledInstance(trophyLabel.getWidth(), trophyLabel.getHeight(),
                Image.SCALE_SMOOTH);
        ...
        do {
            ...
            Image imageQuestion = questionIcon.getImage().getScaledInstance(quizButton[i].getWidth(),
                    quizButton[i].getHeight(), Image.SCALE_SMOOTH);
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         * ----- Quiz 1 - Quiz 5
         * ----- After choosing the Quiz Section they want to play, they will be
         * directed to the respective Quiz Detail Page
         */
        for (int i = 1; i <= 5; i++) {
