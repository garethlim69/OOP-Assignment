...
public class QuizDetails implements ActionListener {
    ...
    // The username of the current user and the Quiz section chosen are passed into
    // this constructot
    public QuizDetails(String username, int chosenQuizNumber) {
         ...
         * -- Since the chosenQuizNumber started by 1, we need to minus 1 to gain the
         * Quiz section
         */
        ...
        // Display the difficulty level (We set the difficulty level for all Quiz
        // section to "Easy")
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         * --- The user will be directed to different quiz set based on the Quiz Section
         * he chose before
         */
